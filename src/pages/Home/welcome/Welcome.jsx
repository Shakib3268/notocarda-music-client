...
const Welcome = () => {
    ...
    return (
        <div className="my-48 px-8">
            <div>
                <Bounce><h1 className="my-5 text-center text-5xl font-bold">Welcome to <span className="text-[#18adc0]">Notocard Music</span></h1></Bounce>
               
                <h5 className="mb-5 mx-auto text-center lg:w-3/5">Notocard Music Music Instrument School is a renowned educational institution specializing in teaching the art of rhythmic music and instrumental skills.
                </h5>
