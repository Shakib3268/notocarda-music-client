  ...
  return (
    <div className="mt-16">
      ...
      <h1 className="text-center text-3xl mt-8 mb-16">
        ...
        <span className="text-purple-500">({myclass?.length})</span>
      </h1>
          ...
          <tbody>
            {myclass?.map((singleclass, index) => (
              <tr key={singleclass._id}>
                ...
                <td
                  className={
                    singleclass.status === "pending"
                      ? "text-red-500 text-[18px] text-bold animate-pulse"
                      : "text-green-600 text-[18px] text-bold"
                  }
                >
                  {singleclass.status}
                </td>
                ...
                <td>
                  {singleclass.status === "aproved" ? (
                    <button
                      className="btnt w-10 rounded "
                      title="your class is aproved you not delet this class"
                      disabled="disabled"
                    >
                    ...
                    <button
                      onClick={() => handleDeletClass(singleclass?._id)}
                      className="bg-red-500 w-10 rounded text-white p-2"
                    >
                      <FaRegTrashAlt className=" text-2xl" />
                    </button>
                  )}
