...
const Allpayment = () => {
    ...
    const handleDeletePayment = (singlePayment) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://notocard-music-server.vercel.app/paymentdelet/${singlePayment?._id}`,{
                    method: 'DELETE',
                })
                .then(res => res.json())
                .then(data => {
                    ...
                    if (data?.deletedCount > 0){
                        ...
                        console.log('Jole dube pani khao');
                    }
                })                                
            }
        })
    ...
    return (
        ...
        <Helmet>
            <title>NotoCard Music/Dashbord/admin/MangePayments</title>
        </Helmet>
